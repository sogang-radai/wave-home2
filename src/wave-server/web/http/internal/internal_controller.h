...
public:
    ...
    ADD_METHOD_TO(
        InternalController::queryDevice,
        "/internal/v1/devices/{deviceId}/query/{queryName}",
        drogon::Post);
    ADD_METHOD_TO(
        InternalController::invokeDeviceAction,
        "/internal/v1/devices/{deviceId}/actions/{actionName}",
        drogon::Post);
    ADD_METHOD_TO(
        InternalController::getPtzCapabilities,
        "/internal/v1/devices/{deviceId}/ptz/capabilities",
        drogon::Get);
    ADD_METHOD_TO(
        InternalController::movePtz,
        "/internal/v1/devices/{deviceId}/ptz/move",
        drogon::Post);
    ADD_METHOD_TO(
        InternalController::stopPtz,
        "/internal/v1/devices/{deviceId}/ptz/stop",
        drogon::Post);
    ADD_METHOD_TO(
        InternalController::zoomPtz,
        "/internal/v1/devices/{deviceId}/ptz/zoom",
        drogon::Post);
    ...
    ADD_METHOD_TO(
        InternalController::captureSnapshot,
        "/internal/v1/devices/{deviceId}/snapshot",
        drogon::Post);
    ...
    ADD_METHOD_TO(
        InternalController::setRuleEnabled,
        "/internal/v1/rules/{ruleId}/enabled",
        drogon::Put);
    ADD_METHOD_TO(
        InternalController::executeRule,
        "/internal/v1/rules/{ruleId}/execute",
        drogon::Post);
    ADD_METHOD_TO(InternalController::listIrCommands, "/internal/v1/ir-commands", drogon::Get);
    ADD_METHOD_TO(
        InternalController::getIrCommand,
        "/internal/v1/ir-commands/{commandId}",
        drogon::Get);
    ...
    ADD_METHOD_TO(
        InternalController::toolScheduleList,
        "/internal/v1/tools/device.schedule.list",
        drogon::Post);
    ADD_METHOD_TO(
        InternalController::toolScheduleCancel,
        "/internal/v1/tools/device.schedule.cancel",
        drogon::Post);
    ...
    ADD_METHOD_TO(
        InternalController::updateScheduleTask,
        "/internal/v1/schedule-tasks/{taskId}",
        drogon::Patch);
    ADD_METHOD_TO(
        InternalController::deleteScheduleTask,
        "/internal/v1/schedule-tasks/{taskId}",
        drogon::Delete);
    METHOD_LIST_END
